...
data_root = '/mnt/disk/drone/riverandroad'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='DroneDataset',
        data_root='/mnt/disk/drone/riverandroad',
        img_dir='image/training2',
        ann_dir='label/training',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(
    ...
    val=dict(
        type='DroneDataset',
        data_root='/mnt/disk/drone/riverandroad',
        img_dir='image/validation',
        ann_dir='label/validation',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='DroneDataset',
        data_root='/mnt/disk/drone/riverandroad',
        img_dir='image/testing',
        ann_dir='label/testing',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
